...
function Sports() {
  return (
    <>
      ...
      <div>
        <h2 className='lg:text-4xl text-3xl font-bold text-center text-black lg:text-left'>Sports Secretary</h2>
        <div className='flex flex-col lg:flex-row gap-4 justify-center items-center mt-5 lg:justify-start' >
            <div className='bg-white text-p px-4 py-6 lg:py-6 lg:px-8 mt-1 rounded-xl lg:rounded-2xl'>
              ...
              <h3 className='lg:text-2xl text-xl font-semibold text-black'>Thatikonda Varun Reddy</h3>
              <address className='pt-3'>
              <h4 className='lg:text-xl text-lg font-semibold'>+91 9154510508</h4> 
