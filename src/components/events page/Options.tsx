...
function Options({eventId}) {
  ...
  return (
    <div className=" lg:hidden flex justify-center mb-5">
        <select ref={optionsRef} onChange={(e)=>{onChangeHandler(e)}} name="events" id="" className="event-selection px-5 py-3 bg-transparent border-2 rounded-lg text-center flex justify-center">
