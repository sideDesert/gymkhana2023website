...
const dummy = 'https://res.cloudinary.com/dwsverefw/image/upload/v1671733197/media%20council/milan_logo_og_rxtdnj.png'
const bg = 'https://gymkhana.iith.ac.in/milan/static/media/image_6.e98b1bc549fcc8032f25.jpeg'
  ...
  return (
    <section className="px-[2rem] py-[2rem] bg-[#000000d1] text-white relative lg:px-[7rem] lg:pt-[4rem] min-h-[100vh] lg:flex lg:flex-col lg:justify-center">
      ...
      <div className="relative z-10">
        <h2 className="text-4xl font-semibold uppercase lg:text-[4rem] lg:font-bold">Milan</h2>
      </div>
     ...
     <div className="w-full h-auto my-6 px-[2rem] lg:col-span-2 lg:flex justify-center items-center">
      ...
      <div className="py-5 lg:col-span-3 self-center">
        ...
        <a href='https://elan.org.in/' target='_blank' rel='noopener noreferrer'> <button className="text-black scale-90 disabled text-xl bg-[#fec93d] px-4 py-3 rounded-lg">
          Navigate to Website
        </button></a>
        </div>
      </div>
